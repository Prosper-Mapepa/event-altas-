          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 text-[11px] text-slate-300">
                <span className="rounded-full bg-slate-900/80 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-slate-300 ring-1 ring-slate-700/80">
                  Featured event
                </span>
                <span className="rounded-full bg-slate-900/70 px-2 py-0.5 text-[10px] text-sky-200 ring-1 ring-sky-500/40">
                  {event.category}
                </span>
              </div>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                ...
                {event.host?.id && (
                  <Link
                    ...
                    className="rounded-xl border border-slate-600/80 bg-slate-900/80 px-4 py-2 text-sm font-medium text-slate-200 transition-colors hover:border-sky-500/60 hover:bg-slate-800/80 hover:text-sky-100"
                  >
                    Message host
                  </Link>
                )}
            ...
            <div className="flex flex-col items-end gap-2 text-right text-[11px] text-slate-300">
              <span className="rounded-full bg-slate-900/90 px-3 py-1 text-xs font-medium text-slate-100 ring-1 ring-slate-700/80">
                {event.time}
              </span>
              <span>{(event.distance ?? "—")} from your position</span>
              <span className="text-sky-200">{event.price}</span>
            </div>
          </div>
